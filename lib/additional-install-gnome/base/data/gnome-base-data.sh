...
ADDITIONAL_PACMAN_PACKAGES=("xfce4-terminal" "firefox" "file-roller" "gvfs" "catfish" "xed" "neofetch" "gparted" "firejail" "avahi" "cups" "cups-filters" "cups-pdf" "ghostscript" "gsfonts" "system-config-printer" "w3m" "conky" "conky-manager" "conky-all" "lm-sensors")
