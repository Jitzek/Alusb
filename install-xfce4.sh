...
home_dir=""
prerequisites=("")
base_packages=("xorg" "base-devel" "xfce4" "xfce4-goodies" "lightdm" "lightdm-gtk-greeter" "lightdm-gtk-greeter-settings" "git" "pipewire" "pipewire-alsa" "pipewire-pulse" "pipewire-jack" "network-manager-applet" "pavucontrol" "file-roller" "appstream-glib")
...
additional_yay_packages=("pamac-nosnap" "ttf-liberation" "downgrade" "mugshot" "update-grub") # "openrgb" - takes a long time to install
additional_pacman_packages=("firefox" "firefox-adblock-plus" "file-roller" "gvfs" "catfish" "gedit" "xed" "neofetch" "gparted" "firejail" "avahi" "cups" "cups-filters" "cups-pdf" "ghostscript" "gsfonts" "system-config-printer" "w3m")
